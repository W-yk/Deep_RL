    ...
    def create_model(self, scope, lr=0.01):
        with tf.variable_scope(scope):
            with tf.variable_scope("Critic"):
                ...
                l1 = tf.layers.batch_normalization(self.s,training=True, name="State_BN")
                l1_ = tf.layers.batch_normalization(self.a,training=True, name="Action_BN")
    ...
    def create_model(self, scope, lr=0.01):
        with tf.variable_scope(scope):
            with tf.variable_scope("Actor"):
                ...
                l1 = tf.layers.batch_normalization(self.s,training=True, name="BN")
...
def target_update_op(self):
    ...
    def predict(self, state):
        ...
        return self.sess.run(self.actions_t, feed_dict={self.s : state})
